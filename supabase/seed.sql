...
INSERT INTO public.tickets (org_id, subject, description, email, name) VALUES
    ('7e7a9db6-d2bc-44a4-95b1-21df9400b7a7', 'Cannot login', 'Getting "Invalid credentials" error when trying to login with correct password', 'rachel@example.com', 'Rachel Martinez'),
    ...
    ('7e7a9db6-d2bc-44a4-95b1-21df9400b7a7', 'Need to update billing info', 'How do I update the credit card on file?', 'sophia@example.com', 'Sophia Patel'),
    ...
    ('9b5e3268-d968-4d48-8063-12f5c65ac2f4', 'Password reset not working', 'Reset link in email leads to 404 error page', 'daniel@example.com', 'Daniel Kim'),
    ...
    ('9b5e3268-d968-4d48-8063-12f5c65ac2f4', 'Feature request: Dark mode', 'Would like dark mode option for reducing eye strain', 'maya@example.com', 'Maya Johnson'),
